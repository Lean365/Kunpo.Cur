...
// <summary>任务提醒实体类</summary>
// <remarks>处理任务提醒的查询、创建、更新、删除和导出等操作</remarks>
// -----------------------------------------------------------------------using System;
...
namespace Kunpo.Cur.Routine.Entities.Task
{
  ...
  /// 任务提醒实体类
  /// </summary>
  [SugarTable("kp_ro_task_reminder")]
  [SugarIndex("idx_task_reminder_code", nameof(ReminderCode), OrderByType.Asc)]
  public class KpTaskReminder : KpBaseEntity
  {
    #region 基本信息
    /// <summary>
    /// 提醒编码
    ...
    /// 提醒状态
    /// </summary>
    [SugarColumn(ColumnName = "reminder_status", ColumnDescription = "提醒状态", IsNullable = false)]
