...
// <summary>通知提醒实体类</summary>
// <remarks>处理通知提醒的查询、创建、更新、删除和导出等操作</remarks>
// -----------------------------------------------------------------------using System;
...
namespace Kunpo.Cur.Routine.Entities.Notification
{
  ...
  /// 通知提醒实体类
  /// </summary>
  [SugarTable("kp_ro_notification_reminder")]
  [SugarIndex("idx_notification_reminder_code", nameof(ReminderCode), OrderByType.Asc)]
  public class KpNotificationReminder : KpBaseEntity
  {
    #region 基本信息
    /// <summary>
    /// 提醒编码
    ...
    /// 提醒内容
    /// </summary>
    [SugarColumn(ColumnName = "reminder_content", ColumnDataType = "nvarchar", Length = 4000, ColumnDescription = "提醒内容", IsNullable = true)]
    public string? ReminderContent { get; set; }

    /// <summary>
    /// 提醒描述
    /// </summary>
    [SugarColumn(ColumnName = "reminder_description", ColumnDataType = "nvarchar", Length = 500, ColumnDescription = "提醒描述", IsNullable = true)]
    ...
    /// 提醒人编码
    /// </summary>
    [SugarColumn(ColumnName = "reminder_user_code", ColumnDataType = "nvarchar", Length = 20, ColumnDescription = "提醒人编码", IsNullable = false)]
    public string? ReminderUserCode { get; set; }

    /// <summary>
    /// 提醒人名称
    /// </summary>
    [SugarColumn(ColumnName = "reminder_user_name", ColumnDataType = "nvarchar", Length = 50, ColumnDescription = "提醒人名称", IsNullable = false)]
    public string? ReminderUserName { get; set; }

    /// <summary>
    /// 提醒部门编码
    /// </summary>
    [SugarColumn(ColumnName = "reminder_dept_code", ColumnDataType = "nvarchar", Length = 20, ColumnDescription = "提醒部门编码", IsNullable = true)]
    public string? ReminderDeptCode { get; set; }

    /// <summary>
    /// 提醒部门名称
    /// </summary>
    [SugarColumn(ColumnName = "reminder_dept_name", ColumnDataType = "nvarchar", Length = 50, ColumnDescription = "提醒部门名称", IsNullable = true)]
    public string? ReminderDeptName { get; set; }
    #endregion
