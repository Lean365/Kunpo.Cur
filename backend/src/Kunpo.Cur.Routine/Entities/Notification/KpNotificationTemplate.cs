...
// <summary>通知模板实体类</summary>
// <remarks>处理通知模板的查询、创建、更新、删除和导出等操作</remarks>
// -----------------------------------------------------------------------using System;
...
namespace Kunpo.Cur.Routine.Entities.Notification
{
  ...
  /// 通知模板实体类
  /// </summary>
  [SugarTable("kp_ro_notification_template")]
  [SugarIndex("idx_notification_template_code", nameof(TemplateCode), OrderByType.Asc)]
  public class KpNotificationTemplate : KpBaseEntity
  {
    #region 基本信息
    /// <summary>
    /// 模板编码
    ...
    /// 默认通知类型
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_type", ColumnDataType = "int", ColumnDescription = "默认通知类型", IsNullable = false)]
    public int DefaultNotificationType { get; set; }

    /// <summary>
    /// 默认通知方式
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_mode", ColumnDataType = "int", ColumnDescription = "默认通知方式", IsNullable = false)]
    public int DefaultNotificationMode { get; set; }

    /// <summary>
    /// 默认通知时间
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_time", ColumnDataType = "int", ColumnDescription = "默认通知时间(分钟)", IsNullable = false)]
    public int DefaultNotificationTime { get; set; }

    /// <summary>
    /// 默认通知间隔
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_interval", ColumnDataType = "int", ColumnDescription = "默认通知间隔(分钟)", IsNullable = false)]
    public int DefaultNotificationInterval { get; set; }

    /// <summary>
    /// 默认通知次数
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_count", ColumnDataType = "int", ColumnDescription = "默认通知次数", IsNullable = false)]
    public int DefaultNotificationCount { get; set; }

    /// <summary>
    /// 默认通知参数
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_parameters", ColumnDataType = "nvarchar", Length = 2000, ColumnDescription = "默认通知参数", IsNullable = true)]
    public string? DefaultNotificationParameters { get; set; }

    /// <summary>
    /// 默认通知标签
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_tags", ColumnDataType = "nvarchar", Length = 500, ColumnDescription = "默认通知标签", IsNullable = true)]
    public string? DefaultNotificationTags { get; set; }

    /// <summary>
    /// 默认通知格式
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_format", ColumnDataType = "nvarchar", Length = 50, ColumnDescription = "默认通知格式", IsNullable = true)]
    public string? DefaultNotificationFormat { get; set; }

    /// <summary>
    /// 默认通知大小
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_size", ColumnDataType = "bigint", ColumnDescription = "默认通知大小", IsNullable = false)]
    public long DefaultNotificationSize { get; set; }

    /// <summary>
    /// 默认通知版本
    /// </summary>
    [SugarColumn(ColumnName = "default_notification_version", ColumnDataType = "int", ColumnDescription = "默认通知版本", IsNullable = false, DefaultValue = "1")]
    public int DefaultNotificationVersion { get; set; } = 1;
    #endregion
  }
}