...
// <summary>文档审批实体类</summary>
// <remarks>处理文档审批的查询、创建、更新、删除和导出等操作</remarks>
// -----------------------------------------------------------------------using System;
...
namespace Kunpo.Cur.Routine.Entities.Document
{
  ...
  /// 文档审批实体类
  /// </summary>
  [SugarTable("kp_ro_document_approval")]
  [SugarIndex("idx_document_approval_code", nameof(ApprovalCode), OrderByType.Asc)]
  public class KpDocumentApproval : KpBaseEntity
  {
    #region 基本信息
    /// <summary>
    /// 审批编码
